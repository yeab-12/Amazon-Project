...
export function renderOrderSummary(){
    ...
    cart.forEach((cartItem) => {
        ...
        const deliveryOptionId=cartItem.deliveryOptionId; // Property should be deliveryOptionId, not deliveryOptionsId (as per cart.js fixes)
    ...
    document.querySelectorAll('.js-delete-link').forEach((link) => {
        link.addEventListener('click', () => {
            ...
            removeFromCart(productId);//to delete by productid
            
            //steps to remove products on checkout page
    ...
    document.querySelectorAll('.js-delivery-option').forEach((element)=>{ // Fixed typo: 'elemenet' to 'element'
