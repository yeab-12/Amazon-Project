...
describe('test suite: renderOrderSummary',()=>{
    ...
    beforeAll((done)=>{
        loadProducts(()=>{
            done();//to control all finish when to the next step runs
        });
    });
    ...
    beforeEach(()=>{
        ...
        spyOn(localStorage,'getItem').and.callFake(()=>{
            return JSON.stringify([{
                ...
                quantity:1,
                deliveryOptionId:'2' // Fixed typo: deliveryOptionnId -> deliveryOptionId
            }]);
        });
    ...
    it('displays the cart',()=>{
        ...
        expect(
            ...
            .innerText).toContain(`Quantity: 1`); // Corrected expectation to 1
        document.querySelector('.js-test-container').innerHTML=``;
    });
